...
import com.x10host.dhanushpatel.barsafety.BuildConfig;
...
public class UberAPIClient {
    ...
    private static UberEndPoint sEndPoint = new UberEndPoint(UberConstants.BASE_UBER_URL_V1, UberConstants.BASE_UBER_URL_V1_1);
